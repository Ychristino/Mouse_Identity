...
from page.events.event_record_data import switch_change, start_record, stop_record
...
switch_main_user.id = 'is_main_user'
input_text_username.id = 'user_name'
select_game.id = 'game_name'
button_play.id = 'play_button'
button_stop.id = 'stop_button'
